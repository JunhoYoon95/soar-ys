  ...
  e.extend(a.prototype, {
    ...
    parseDate: function parseDate(t, i, s) {
      ...
      for (a = 0; t.length > a; a++) {
        if (b) '\'' !== t.charAt(a) || _('\'') ? w() : b = !1;else switch (t.charAt(a)) {
          case 'd':
            v = x('d');
            break;
    ...
    _generateHTML: function _generateHTML(e) {
      ...
      if (0 > Z && (Z += 12, et--), $) for (t = this._daylightSavingAdjust(new Date($.getFullYear(), $.getMonth() - V[0] * V[1] + 1, $.getDate())), t = X && X > t ? X : t; this._daylightSavingAdjust(new Date(et, Z, 1)) > t;) {
        Z--, 0 > Z && (Z = 11, et--);
      }
  ...
  e.effects = {
    ...
    function t(t) {
      var i,
          ...
          n = {};
      if (a && a.length && a[0] && a[a[0]]) for (s = a.length; s--;) {
